...
CREATE TABLE IF NOT EXISTS `programadores` (
  ...
  `LenguajeDominante` varchar(50) NOT NULL,
  UNIQUE KEY `id` (`id`)
);

INSERT INTO `programadores` (`id`, `Nombre`, `Apellido`, `LenguajeDominante`) VALUES
(1, 'Javier', 'Salinas', 'Python'),
(2, 'Alexis', 'Perez', 'Java'),
(3, 'Gerardo', 'Pineda', 'JavaScript');